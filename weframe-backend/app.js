...
const aiRoutes = require('./routes/aiRoutes'); // 超分辨率路由
const copyrightRoutes = require('./routes/copyrightRoutes'); // 版权保护路由
...
app.use('/ai', aiRoutes); // 超分辨率路由
app.use('/copyright', copyrightRoutes); // 版权保护路由
